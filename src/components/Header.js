    ...
    return (
        <header className="header">
            <div className="container flex-spacebetween">
                <a href="/"><LogoLight className="logo" /></a>
                <div>
                    <a className="icon-link" href="https://github.com/Kuntal-Das/Rhythm"><GithubIcon className="icon" /></a>
                    <a className="icon-link" href="https://twitter.com/Kuntal449"><TwitterIcon className="icon" /></a>
                </div>
            </div>
        </header>
    )
